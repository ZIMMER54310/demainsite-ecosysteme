...
echo ============================================================
echo.
echo Le script cherche automatiquement le CSV dans data, DemainSite, Telechargements, OneDrive et Documents.
echo Si rien n'est trouve, depose le CSV dans le dossier data.
echo.
