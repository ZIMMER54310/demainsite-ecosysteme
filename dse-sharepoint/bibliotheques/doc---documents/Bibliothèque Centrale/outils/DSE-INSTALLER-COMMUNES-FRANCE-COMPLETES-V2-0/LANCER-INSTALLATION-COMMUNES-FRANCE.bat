...
echo ============================================================
echo  DEMAINSITE ECOSYSTEME - COMMUNES DE FRANCE COMPLETES V2.0
echo ============================================================
echo.
echo Ce lanceur va :
...
if %errorlevel%==0 (
    ...
    pwsh.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0RUN-INSTALL-COMMUNES-FRANCE-COMPLETES.ps1" -Mode Update
)
