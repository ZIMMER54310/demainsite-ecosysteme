...
chcp 65001 >nul
cd /d "%~dp0"
title DemainSite - Villes par departement V1.1
echo ============================================================
echo  DEMAINSITE ECOSYSTEME - VILLES PAR DEPARTEMENT V1.1
echo ============================================================
echo.
...
echo.
echo Important : si tu tapes OUI, le script comprendra TOUS.
echo.
